...
var build_state = 'prod',
    ...
    sass_files = {
        "www/css/ionic.app.min.css": "scss/ionic.app.scss",
        "www/css/custom.min.css": "scss/custom.scss"
    },
...
module.exports = function(grunt) {
    ...
    grunt.registerTask('prod', ['sass:prod', 'haml:prod']);

    // when `grunt dev` is run, do the following tasks
    grunt.registerTask('dev', ['sass:dev', 'haml:dev']);
